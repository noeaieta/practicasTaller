...
float calcularDistanciaXOrdenes(escenario_t*, barril_t*);
...
void calcular_distancia(escenario_t* escenario, barril_t* barril){
	...
	float distancia_x = calcularDistanciaXOrdenes(escenario, barril);
...
float calcularDistanciaXOrdenes(escenario_t* es, barril_t* barril){
	unsigned int i;
