========================================================================
    APLICACIÓN DE LA CONSOLA: Información general del proyecto 
                              rectangulos
========================================================================

AppWizard ha creado esta aplicación rectangulos.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación rectangulos.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado rectangulos.pch y un archivo de 
